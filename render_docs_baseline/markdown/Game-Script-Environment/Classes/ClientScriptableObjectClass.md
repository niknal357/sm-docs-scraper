...
**Script template:** [View starter script](ClientScriptableObjectClass-Template.md)
...
``` { .lua .api-signature }
ClientScriptableObjectClass:server_onCreate(  )
ClientScriptableObjectClass:client_onCreate(  )
```
...
``` { .lua .api-signature }
ClientScriptableObjectClass:server_onDestroy(  )
ClientScriptableObjectClass:client_onDestroy(  )
```
...
``` { .lua .api-signature }
ClientScriptableObjectClass:server_onRefresh(  )
ClientScriptableObjectClass:client_onRefresh(  )
```
...
``` { .lua .api-signature }
ClientScriptableObjectClass:server_onFixedUpdate( timeStep )
...
``` { .lua .api-signature }
ClientScriptableObjectClass:server_onReceiveUpdate(  )
```
...
``` { .lua .api-signature }
ClientScriptableObjectClass:client_onUpdate( deltaTime )
```
